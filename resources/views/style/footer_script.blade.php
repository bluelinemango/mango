...
<script data-pace-options='{ "restartOnRequestAfter": true }' src="{{cdn('js/plugin/pace/pace.min.js')}}"></script>

<!-- Link to Google CDN's jQuery + jQueryUI; fall back to local -->
<script src="{{cdn('js/libs/jquery-2.1.1.min.js')}}"></script>

<script src="{{cdn('js/libs/jquery-ui-1.10.3.min.js')}}"></script>

<!-- IMPORTANT: APP CONFIG -->
<script src="{{cdn('js/app.config.js')}}"></script>

<!-- JS TOUCH : include this plugin for mobile drag / drop touch events-->
<script src="{{cdn('js/plugin/jquery-touch/jquery.ui.touch-punch.min.js')}}"></script>
...
<!-- JARVIS WIDGETS -->
<script src="{{cdn('js/smartwidgets/jarvis.widget.min.js')}}"></script>

<!-- EASY PIE CHARTS -->
<script src="{{cdn('js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js')}}"></script>

<!-- SPARKLINES -->
<script src="{{cdn('js/plugin/sparkline/jquery.sparkline.min.js')}}"></script>
...
<script src="{{cdn('js/plugin/select2/select2.min.js')}}"></script>

<!-- JQUERY UI + Bootstrap Slider -->
<script src="{{cdn('js/plugin/bootstrap-slider/bootstrap-slider.min.js')}}"></script>

<!-- browser msie issue fix -->
<script src="{{cdn('js/plugin/msie-fix/jquery.mb.browser.min.js')}}"></script>

<!-- FastClick: For mobile devices -->
<script src="{{cdn('js/plugin/fastclick/fastclick.min.js')}}"></script>
...
<script src="{{cdn('js/speech/voicecommand.min.js')}}"></script>

<!-- SmartChat UI : plugin -->
<script src="{{cdn('js/smart-chat-ui/smart.chat.ui.min.js')}}"></script>
<script src="{{cdn('js/smart-chat-ui/smart.chat.manager.min.js')}}"></script>
