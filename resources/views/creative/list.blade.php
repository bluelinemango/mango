        ...
        $(document).ready(function() {
            ...
            var jqgrid_data = [
                ...
                @if(!is_null($index->getAdvertiser->GetClientID))
                {
                    ...
                    status: '<a id="creative{{$index->id}}" href="javascript: ChangeStatus(`creative`,`{{$index->id}}`)"><span class="label label-danger">Disable</span> </a>',
                    @endif
                    date_modify : '{{$index->updated_at}}',
                    full_edit: '<a class="btn btn-info" href="{{url('/client/cl'.$index->getAdvertiser->GetClientID->id.'/advertiser/adv'.$index->getAdvertiser->id.'/creative/crt'.$index->id.'/edit')}}"><i class="fa fa-edit "></i></a>'
                },
                @endif
                @endforeach
            ];
            ...
            jQuery("#jqgrid").jqGrid({
                ...
                datatype : "local",
                height : 'auto',
                colNames : ['Actions', 'ID', 'Name','Size','Status','Modify Date','Full Actions'],
                colModel : [{
                    name : 'act',
                    index : 'act',
                    sortable : false
