            ...
            $(function () {
                ...
                $("#campaign_grid").jsGrid({
                    ...
                    fields: [
                        ...
                        {name: "action", title: "Edit | +Camp | Clone", sorting: false, width: 110, align: "center"},
                        {type: "control"}
                    ]
